...
Η αναφορά βρίσκεται στο `report/report.tex` με **όλους τους χρόνους** ήδη συμπληρωμένους.

### Μεταγλώττιση PDF

**Επιλογή Α — WSL:**
```bash
bash ~/dsml2026-project/report/compile.sh
# ή χειροκίνητα:
sudo apt install texlive-latex-base texlive-latex-recommended texlive-lang-european
cd ~/dsml2026-project/report && pdflatex report.tex && pdflatex report.tex
```

**Επιλογή Β — Overleaf:** ανέβασε το `report.tex` (και `LLM_USAGE.md` ως κείμενο).
